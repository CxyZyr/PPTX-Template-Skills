...
def set_text(
    ...
    *,
    ...
    # Fix vertical text for CJK: if text_frame is vertical and new text is CJK, switch to horizontal
    combined_text = ' '.join(lines)
    if _is_vertical_text_frame(text_frame) and _is_cjk_text(combined_text):
        _set_horizontal_text_frame(text_frame)
